  ...
  return (
    <div className="relative h-screen flex flex-col overflow-hidden noise-overlay">
      ...
      <div className="flex flex-1 min-h-0 relative z-10">
        {/* MAUK sidebar - left */}
        <aside className="hidden lg:block w-80 min-w-80 flex-shrink-0 bg-card/30 backdrop-blur-sm relative">
        ...
        {/* Main feed */}
        <main className="flex-1 bg-background/80 relative min-w-0">
