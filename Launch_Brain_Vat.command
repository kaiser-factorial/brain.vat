...
osascript -e "tell application \"Terminal\" to do script \"export PATH=\\\"/opt/homebrew/bin:\$PATH\\\" && cd $BASE_DIR/convo_bots/brain.vat_v0 && npm run dev\""
